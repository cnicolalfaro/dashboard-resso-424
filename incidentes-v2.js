(function () {
  ...
  function bindEvents() {
    ...
    $("#incOpenBars").onclick=(event)=>{const button=event.target.closest("[data-category]");if(!button)return;state.category=button.dataset.category;$("#incCat").value=state.category;renderAll();$("#incidentesPanel").scrollIntoView({behavior:"smooth"});};
